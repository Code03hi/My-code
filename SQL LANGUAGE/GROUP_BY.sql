...
ALTER TABLE EMPLOYEE_DETAILS ADD DEP_ID INT;

SELECT * FROM GROUP BY CITY SUM(SALARY) AS EMPLOYEE_SALARY

SELECT CITY,SUM(SALARY) AS [Total Salary According to cities ] FROM EMPLOYEE_DETAILS 
GROUP BY CITY ;

SELECT GENDER,CITY,SUM(SALARY) AS [Total Salary According to cities ] FROM EMPLOYEE_DETAILS 
GROUP BY GENDER,CITY ;

SELECT GENDER,SUM(SALARY) AS [Total Salary According to cities ] FROM EMPLOYEE_DETAILS 
GROUP BY GENDER ;